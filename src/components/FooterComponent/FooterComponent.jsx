...
export const FooterComponent = () => {
  return (
    <div className='relative mt-[167px] lg:pb-[114px] h-full'>
      ...
      <div className="flex flex-col justify-center items-center px-6 lg:flex-row lg:gap-14 absolute z-40 top-0 pt-[92px]">
        <h2 className="text-light font-black text-center text-[32px] leading-[36px] md:text-[40px] md:leading-[44px] mb-6 md:mb-8 md:px-[130px] lg:px-0 lg:mb-0 lg:text-left lg:w-[30%]">Experience more together</h2>
        <p className='text-light font-medium text-lg text-center leading-[26px] md:px-[70px] lg:px-0 lg:text-left lg:w-[30%]'>Stay connected with reliable HD meetings and unlimited one-on-one and group video sessions.</p>
