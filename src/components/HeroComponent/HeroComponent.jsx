export const HeroComponent = () => {
  return (
    <div className="px-6 mt-12 md:px-[215px] md:mt-[72px]">
        ...
        <div className="flex flex-col justify-center items-center gap-4 md:flex-row mb-[80px] md:mb-[117px] xl:mb-[110px]">
